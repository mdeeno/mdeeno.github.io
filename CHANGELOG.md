...
### 2026-04-01
**[콘텐츠] 중복 타이틀 블로그 포스트 77건 정리**
- posting-engine UTM/slug/timezone 개선 시 구버전 포스트가 잔존하던 문제 해결
- 전체 포스트 532 → 455건 (77건 구버전 제거)
- 판별 기준: UTM 파라미터, slug 필드, ISO 타임존 유무 (개선 버전 유지)
- 빌드 검증 완료 (hugo --minify 정상)
- 백업: `/tmp/duplicate_posts/`
