...
**Q1. 맥쿼리인프라와 리얼티인컴 중 은퇴자에게 더 적합한 배당주는 무엇인가요?**

원화 기반의 안정적인 배당을 원하면 맥쿼리인프라, 달러 자산 분산과 월배당을 원하면 리얼티인컴이 적합합니다. 두 종목을 50:50으로 분산 보유하면 통화 리스크를 줄이면서 안정적인 현금 흐름을 확보할 수 있습니다.

**Q2. 배당소득세 15%를 절세할 수 있는 방법이 있나요?**

ISA(개인종합자산관리계좌)나 연금저축 계좌를 활용하면 배당소득에 대한 과세를 이연하거나 세율을 낮출 수 있습니다. 특히 연금저축은 배당소득 종합과세 대상에서 제외되어 고액 배당 투자자에게 유리합니다.
