...
**Q1. 젠트리피케이션이 진행 중인 지역에 투자해도 괜찮은가요?**
젠트리피케이션 초기~중기 단계에서는 자산 가치 상승의 기회가 있습니다. 다만 임대료가 임계점에 도달한 후기 단계(성수동 등)에서는 수익률 하락 리스크가 크므로, 진입 시점 판단이 중요합니다.

**Q2. 상가 투자 시 DSR 규제가 주택과 동일하게 적용되나요?**
상가 담보 대출은 주택 대출과 달리 LTV·DSR 규제가 다소 완화되어 있지만, 2026년 현재 총부채 기준 DSR 40%가 적용됩니다. 기존 주택담보대출과 합산되므로 반드시 사전 확인이 필요합니다.
