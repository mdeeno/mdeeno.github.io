---
  title: "미륭 분담금 리스크 분석 | M-DEENO"
  description: "미륭(노원구) 재건축 분담금 리스크를 시나리오별로 분석합니다. 비례율 108%, 리스크 등급 R1. 공사비 변동 시 분담금 변화를 확인하세요."
  date: "2026-06-12"
  lastmod: "2026-06-12"
  slug: "미륭-노원구"
  layout: "complex"
...
아래는 미륭의 공사비 변동 시나리오별 추정 분담금입니다.
...
- [광운대역 인근 미륭·미성·삼호, 6700가구 대단지로 재건축 (한국경제)](https://www.hankyung.com/article/202411140840i)
