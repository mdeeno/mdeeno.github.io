---
  title: "상계주공10 분담금 리스크 분석 | M-DEENO"
  description: "상계주공10(노원구) 재건축 분담금 리스크를 시나리오별로 분석합니다. 비례율 110%, 리스크 등급 R1. 공사비 변동 시 분담금 변화를 확인하세요."
  date: "2026-06-12"
  lastmod: "2026-06-12"
  slug: "상계주공10-노원구"
  layout: "complex"
  ...
  complexData:
    ...
    district: "노원구"
    city: "서울특별시"
    location: "서울특별시 노원구 상계동 노원로 564"
    stage: "사업시행인가"
    buildYear: 1988
    households: null
    proportionRate: 110
...
아래는 상계주공10의 공사비 변동 시나리오별 추정 분담금입니다.
...
- [상계주공10단지 재건축 정밀안전진단 통과 - 브릿지경제](https://www.viva100.com/article/20241206500156)
- [상계주공10단지, 신속통합기획으로 재건축 추진 - 위클리한국주택경제신문](http://www.arunews.com/news/articleView.html?idxno=49854)
