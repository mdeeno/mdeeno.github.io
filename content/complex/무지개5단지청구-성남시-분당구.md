---
  title: "무지개(5단지)(청구) 분담금 리스크 분석 | M-DEENO"
  description: "무지개(5단지)(청구)(성남시 분당구) 재건축 분담금 리스크를 시나리오별로 분석합니다. 비례율 102%, 리스크 등급 R2. 공사비 변동 시 분담금 변화를 확인하세요."
  date: "2026-06-12"
  lastmod: "2026-06-12"
  slug: "무지개5단지청구-성남시-분당구"
  layout: "complex"
  type: "complex"
  tags:
    - "재건축"
  ...
  complexData:
    ...
    district: "성남시 분당구"
    city: "경기도"
    location: "경기도 성남시 분당구 구미동 무지개로 144"
    stage: "사업시행인가"
    buildYear: 1995
    households: null
    proportionRate: 102
...
아래는 무지개(5단지)(청구)의 공사비 변동 시나리오별 추정 분담금입니다.
...
- [갈등 가능성 낮췄다…결합재건축으로 속도내는 분당 무지개마을 | 한국경제](https://www.hankyung.com/article/202605284342i)
